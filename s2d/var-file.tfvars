project_id="playground-s-11-f479ccfc"  #update the project here
vpc_name="webappnet"
region="us-east1"
...
server_dc = {
  dc01={    
    ...
    metadata = {
      domain      = "example.net"
      windows-startup-script-url ="dc01.ps1"   
    } 
    instance_tags = ["wsfc"]
    additional_disks = []
  },
...
server_vm_info = {
  node-1={    
    ...
    #source_image      = "windows-cloud/windows-2019"
    source_image      = "playground-s-11-f479ccfc/image-2016-custom"
    boot_disk_size_gb = 70
    ...
    metadata = {
      domain      = "example.net"
      enable-wsfc = true
      windows-startup-script-url ="specialize-node.ps1" 
    }
  ...
  witness={    
    ...
    metadata = {
      domain      = "example.net"
      windows-startup-script-url ="witness-node.ps1"           
    } 
    instance_tags = ["wsfc"]
    additional_disks = []
  },
