project_id="playground-s-11-885b8fc9"  #update the project here
vpc_name="webappnet"
region="us-east1"
...
server_dc = {
  dc01={    
    ...
    metadata = {
      domain      = "example.net"
      windows-startup-script-url ="gs://storage-3-9-2022/dc01.ps1"   
    } 
    instance_tags = ["wsfc"]
    additional_disks = []
  },
...
server_vm_info = {
  node-1={    
    ...
    metadata = {
      domain      = "example.net"
      enable-wsfc = true
      windows-startup-script-url ="gs://storage-3-9-2022/specialize-node.ps1" 
    }
  ...
  witness={    
    ...
    metadata = {
      domain      = "example.net"
      windows-startup-script-url ="gs://storage-3-9-2022/witness-node.ps1"           
    } 
    instance_tags = ["wsfc"]
    additional_disks = []
  },
