...
resource "google_storage_bucket" "bucket" {
  for_each                    = var.create_storage ? var.storage : {}
...
resource "google_storage_bucket_iam_member" "bucket" {
  ...
  depends_on = [google_compute_backend_bucket.bucket]
}
...
resource "google_compute_url_map" "url_map" {
  ...
  project         = var.project_id
  default_service = var.create_storage ? google_compute_backend_bucket.bucket[var.default_service].self_link : module.lb-http.backend_services[var.default_service].self_link
    ...
    content {
      ...
      dynamic "path_rule" {
        ...
        content {
          ...
          service = path_rule.value.bucket_backend ? google_compute_backend_bucket.bucket[path_rule.value.service_name].self_link :  module.lb-http.backend_services[path_rule.value.service_name].self_link
